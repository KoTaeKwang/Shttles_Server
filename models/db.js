...
exports.getOrderDetailTemp = function(order_id,callback){
    var obj = [{
        "order_id" : 2,
        ...
        "option" : [{"name" : "샷추가"},{"name":"hot"}]
        } 
            ],
        "food" : [
            {"name"  : "짜장면", "count" : 2,"price":6000,
         "option" : [{"name" : "곱빼기"}]
                     }]
    }]
    callback(obj);
...
exports.insertOrderTemp = function(data,callback){
    var obj = {};
    callback(obj)
}
